...
export function TagSelector({
    ...
    const [module, setModule] = useState<string>(NixModule.REAL_ESTATE)
                            ...
                            {availableTags.map((tag) => (
                                <ComboboxItem key={tag.id} value={tag}>
                                    <div className="min-w-0">
                                        <div className="truncate font-medium">{tagLabel(tag)}</div>
